...
#+begin_src emacs-lisp
  ...
  (dolist (km (list clojure-mode-map emacs-lisp-mode-map))
    (define-key km (kbd "C-c )") 'paredit-forward-slurp-sexp)
    (define-key km (kbd "C-c (") 'paredit-forward-barf-sexp))
#+end_src
