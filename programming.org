...
#+begin_src emacs-lisp
  ...
  (keymap-set meomacs-toggle-map "y" 'topsy-mode)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load "flymake"
    ...
    (keymap-set flymake-mode-map "C-c f b" 'flymake-show-buffer-diagnostics)
    (keymap-set flymake-mode-map "C-c f a" 'flymake-show-project-diagnostics)
