...
;;
;; This theme highlights only static information, which
;; in my opinion makes reading code easier. Using too many colors
;; makes everything distractive which is not good for everyday
;; programming.
;;
;; All colors have similar contrast, which means we do not stress nor
;; ignore any part of the text.  Comments should be conidered as much
;; important as code.
;;
;; We do not make the whole theme blueish which is popular today
;; , because it makes reading more stressful.
