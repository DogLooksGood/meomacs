...
#+begin_src emacs-lisp
  ...
  (defvar meomacs-after-load-theme-hook nil
    "Hooks to run when theme changed.")
  ...
  (defun meomacs-load-theme ()
    (when-let ((theme (car meomacs-themes)))
      ...
      (unless (eq theme 'default)
        (load-theme theme t)
        (run-hooks 'meomacs-after-load-theme-hook))))
  ...
  (keymap-set global-map "C-c t t" 'meomacs-next-theme)
