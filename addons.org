...
#+begin_src emacs-lisp
  (keymap-set meomacs-toggle-map "m" 'smerge-mode)
  (keymap-set meomacs-addon-map "m" 'magit-status)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (keymap-set meomacs-addon-map "M" 'ement-connect)
#+end_src


* COMMENT Telegram client with Telega
...
#+begin_src emacs-lisp
  ...
  (keymap-set meomacs-addon-map "T" 'telega)
...
#+begin_src emacs-lisp
  ...
  (keymap-set meomacs-addon-map "p" 'pass)
...
#+begin_src emacs-lisp
  ...
  (keymap-set meomacs-toggle-map "d" 'direnv-mode)
  ...
  (with-eval-after-load "gptel"
    (setq gptel-directives
          '((default . "You are a large language model living in Emacs and a helpful assistant. Respond concisely.")
            (programming . "You are a large language model and a careful programmer. Provide code and only code as output without any additional text, prompt, note. Provide code without markdown syntax and triple backticks.")
